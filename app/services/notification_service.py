...
from app.models import User, Event, Attendee, Round, Match
...
class NotificationService:
    ...
    async def send_round_notification(
        ...
        if notification_type == NotificationType.ROUND_STARTED:
            ...
            message.update({
                "title": "Break Over",
                "message": "Break period has ended"
            })
    ...
    async def send_match_notification(
        ...
        if notification_type == NotificationType.MATCH_CREATED:
            ...
            await connection_manager.send_to_user(message_1, match_obj.attendee1.user_id)
            ...
            await connection_manager.send_to_user(message_2, match_obj.attendee2.user_id)
