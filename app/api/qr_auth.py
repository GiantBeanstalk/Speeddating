...
from app.services import create_qr_service, create_pdf_service
...
async def get_qr_code_image(
    ...
    try:
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": f"inline; filename=qr_code_{attendee_id}.png"}
        )
...
async def get_attendee_badge(
    ...
    try:
        ...
        return StreamingResponse(
            ...
            headers={"Content-Disposition": f"inline; filename=badge_{attendee_id}.pdf"}
        )
...
async def get_event_badges(
    ...
    try:
        ...
        return StreamingResponse(
            pdf_badges,
            media_type="application/pdf",
            headers={"Content-Disposition": f"attachment; filename=event_badges_{event_id}.pdf"}
        )
