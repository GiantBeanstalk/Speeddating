...
class CSRFProtection:
    ...
    def __init__(self, secret_key: str | None = None, token_lifetime: int = 3600):
        """
...
def require_csrf_token(request: Request, session_id: str | None = None) -> None:
    """Require and validate CSRF token from request."""
...
def add_csrf_to_templates(templates: Jinja2Templates) -> None:
    ...
    def csrf_token(session_id: str | None = None) -> str:
