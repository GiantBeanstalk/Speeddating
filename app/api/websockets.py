    ...
    try:
        ...
        if user.is_organizer:
            ...
            event_result = await session.execute(
                ...
                .where(and_(Event.id == event_id, Attendee.user_id == user.id))
            )
        ...
        await connection_manager.connect(
            websocket, connection_id, user, room_type="event", room_id=event_id
        )
        ...
        try:
            while True:
                ...
                if message_type == "ping":
                    ...
                    await connection_manager.send_personal_message(
                        {
                            ...
                            "current_round": getattr(
                                event, "current_round_number", None
                            ),
                            "countdown_status": countdown_status,
                        },
                        connection_id,
                    ...
                    await connection_manager.send_personal_message(
                        {"type": "timer_sync", "active_timers": active_timers},
                        connection_id,
                    )
...
async def websocket_round_timer(
    ...
    try:
        ...
        connection_id = str(uuid.uuid4())
        await connection_manager.connect(
            websocket, connection_id, user, room_type="round_timer", room_id=round_id
        )
        ...
        try:
            while True:
                ...
                if message_type == "ping":
                    ...
                    timer_status = timer_manager.get_timer_status(round_id)
                    await connection_manager.send_personal_message(
                        {"type": "timer_status", "timer_status": timer_status},
                        connection_id,
                    )
...
async def websocket_admin_dashboard(
    ...
    try:
        ...
        connection_id = str(uuid.uuid4())
        await connection_manager.connect(
            websocket, connection_id, user, room_type="admin_dashboard"
        )
        ...
        try:
            while True:
                ...
                if message_type == "ping":
                    ...
                    stats = connection_manager.get_connection_stats()
                    await connection_manager.send_personal_message(
                        {"type": "connection_stats", "stats": stats}, connection_id
                    )
