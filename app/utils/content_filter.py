...
class ContentFilterResult:
    ...
    def violation_message(self) -> str:
        ...
        return "Your bio contains content that is not allowed: " + ", ".join(self.violations) + \
    ...
    def filter_bio(self, bio: str) -> ContentFilterResult:
        ...
        for pattern in self.url_patterns:
            ...
            if matches:
                url_found = True
                # Remove the URLs
                cleaned_bio = re.sub(pattern, '[REMOVED]', cleaned_bio, flags=re.IGNORECASE)
